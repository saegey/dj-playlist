# DJ Playlist — System Architecture (for Codex)
...
- **See**: `my-collection-search/AGENTS.md` for detailed app architecture
...
- **Purpose**: Exposes collection tools to Codex via Model Context Protocol
...
- **Register**: `Codex mcp add --transport stdio --scope project groovenet -- node /path/to/mcp-server/build/index.js`
...
See `my-collection-search/AGENTS.md` for detailed frontend/API development guide.
...
- `my-collection-search/AGENTS.md` — Deep dive into Next.js app architecture
