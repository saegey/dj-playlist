...
T = TypeVar("T", bound="PatchApiTracksResponse200")



@_attrs_define
class PatchApiTracksResponse200:
    """ 
        Attributes:
            track_id (str):
            friend_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_api_tracks_response_200 = cls(
            track_id=track_id,
            friend_id=friend_id,
            id=id,
            title=title,
        ...
        patch_api_tracks_response_200.additional_properties = d
        return patch_api_tracks_response_200
