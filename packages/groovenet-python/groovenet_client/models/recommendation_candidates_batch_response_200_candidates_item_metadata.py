...
T = TypeVar("T", bound="RecommendationCandidatesBatchResponse200CandidatesItemMetadata")



@_attrs_define
class RecommendationCandidatesBatchResponse200CandidatesItemMetadata:
    """ 
        Attributes:
            title (str | Unset):
            artist (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recommendation_candidates_batch_response_200_candidates_item_metadata = cls(
            title=title,
            artist=artist,
            album=album,
            bpm=bpm,
        ...
        recommendation_candidates_batch_response_200_candidates_item_metadata.additional_properties = d
        return recommendation_candidates_batch_response_200_candidates_item_metadata
