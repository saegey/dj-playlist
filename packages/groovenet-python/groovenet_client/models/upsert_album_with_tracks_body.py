...
T = TypeVar("T", bound="UpsertAlbumWithTracksBody")



@_attrs_define
class UpsertAlbumWithTracksBody:
    """ 
        Attributes:
            release_id (str):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        files.append(("release_id", (None, str(self.release_id).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upsert_album_with_tracks_body = cls(
            release_id=release_id,
            album=album,
            tracks=tracks,
            friend_id=friend_id,
        ...
        upsert_album_with_tracks_body.additional_properties = d
        return upsert_album_with_tracks_body
