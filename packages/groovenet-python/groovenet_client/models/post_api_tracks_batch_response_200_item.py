...
T = TypeVar("T", bound="PostApiTracksBatchResponse200Item")



@_attrs_define
class PostApiTracksBatchResponse200Item:
    """ 
        Attributes:
            track_id (str):
            friend_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_tracks_batch_response_200_item = cls(
            track_id=track_id,
            friend_id=friend_id,
            id=id,
            title=title,
        ...
        post_api_tracks_batch_response_200_item.additional_properties = d
        return post_api_tracks_batch_response_200_item
