...
T = TypeVar("T", bound="GetApiTracksIdResponse200")



@_attrs_define
class GetApiTracksIdResponse200:
    """ 
        Attributes:
            track_id (str):
            friend_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_tracks_id_response_200 = cls(
            track_id=track_id,
            friend_id=friend_id,
            id=id,
            title=title,
        ...
        get_api_tracks_id_response_200.additional_properties = d
        return get_api_tracks_id_response_200
